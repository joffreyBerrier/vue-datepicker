  ...
  <div id="app" style="margin: 0 auto;">
    ...
    <div>
      ...
      <div class="box">
        ...
        <Calendar :lastDateAvailable="lastDateAvailable" show-year>
          <!-- Insert content here -->
          <div slot="content">
            Hello
          </div>
      ...
      <div class="box">
        ...
        <Calendar :lastDateAvailable="lastDateAvailable" />
      </div>
      <div class="box">
        <h3>
      ...
      <div class="box">
        ...
        <Calendar :disableCheckoutOnCheckin="true" :minNights="0" />
      </div>
      <div class="box">
        <h3>Allow selection of single day</h3>
        <Calendar :singleDaySelection="true" />
      </div>
      <div class="box">
      ...
      <div class="box">
        ...
        <Calendar :endDate="new Date(new Date().getFullYear(), 11, 31)" />
      </div>
      <div class="box">
        <h3>Block all dates after September 15th</h3>
        <Calendar :endDate="new Date(new Date().getFullYear(), 8, 15)" />
      </div>
      <div class="box">
      ...
      <div class="box">
        ...
        <Calendar :minNights="3" :showBottomBar="true" />
      </div>
      <div class="box">
      ...
      <div class="box">
        <h3>Show year</h3>
        <Calendar :showYear="true" />
      </div>
      <div class="box">
        <h3>Custom date format with i18n (e.g.: pt-PT)</h3>
        <Calendar format="MMMM D" :i18n="ptPT" />
      </div>
      <div class="box">
      ...
      <div class="box">
        ...
        <Calendar :firstDayOfWeek="1" :checkInValue="new Date()" />
      </div>
      <div class="box">
