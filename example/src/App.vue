...
const bookedDates: Ref<string[]> = ref(['2023-09-12', '2023-09-13', '2023-09-14', '2023-09-15'])
...
<template>
  <div class="p-4">
    ...
    <button class="px-4 py-3 bg-black text-white hover:bg-grey mb-4" @click="toggleAlwaysVisible">
      Show Calendar
    </button>
